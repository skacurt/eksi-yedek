...
export type StartRuleNames = "eksi_text";
export interface ParseOptions<T extends StartRuleNames = "eksi_text"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"eksi_text">>(
  input: string,
  options?: Options,
): any;
